...
public class Manager extends AbstractStoreEmployee {
    ...
    public String evaluatePerformance() {
        if(getNumberOfHoursWorked() > 20 && salesDone > 10000){
            return super.employeeName + " is an outstanding Manager with exceptional sales performance!";
        }else if(getNumberOfHoursWorked() > 15 && (salesDone > 5000 && salesDone <= 10000)){
            return super.employeeName + " is a highly skilled Manager with impressive sales results.";
        }else if(getNumberOfHoursWorked() > 10 && (salesDone > 2000 && salesDone <= 5000)){
            return super.employeeName + " is a competent Manager.";
        }else{
