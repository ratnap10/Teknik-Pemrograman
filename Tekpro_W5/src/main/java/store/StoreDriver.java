...
public class StoreDriver {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        List<DesignStrategist> DesignStrategist = new ArrayList<DesignStrategist>();
        while (sc.hasNext()) {
            ...
            if (employeeType.equals("Manager")) {
             ...
             //    Then add the salesAssociate object to the arrayList of salesAssociateList
                ...
                int doneProjects = sc.nextInt();
                DesignStrategist designer = new DesignStrategist(doneProjects, numberOfHoursWorked,
                        hourlyRate, storeDetails, basePay, empName);
                DesignStrategist.add(designer);
                if(sc.hasNext()) {
                    sc.nextLine();
                }
            } else {
        ...
        for (Manager manager : managerList) {
            ...
            System.out.println(manager.evaluatePerformance());
            System.out.println("The store quality is " + manager.evaluateStoreQuality());
            System.out.print("Is " + manager.getEmployeeName() + " tired? ");
            if(manager.isTired()==true){
                System.out.println("Yes, please give them a day off and let them sleep.");
            }else{
                System.out.println("No, give them more work.");
            }
        ...
        for (SalesAssociate salesAssociate : SalesAssociateList) {
            ...
            System.out.println(salesAssociate.evaluatePerformance());
            System.out.println("The store quality is " + salesAssociate.evaluateStoreQuality());
            System.out.print("Is " + salesAssociate.getEmployeeName() + " tired? ");
            if(salesAssociate.isTired()==true){
                System.out.println("Yes, please give them a day off and let them sleep.");
            }else{
                System.out.println("No, give them more work.");
            }
        ...
        System.out.println("******************************************************");
        System.out.println("Number of employees working as DESIGN STRATEGIST are: " + DesignStrategist.size());
        System.out.println("******************************************************");
        pwd.println("******************************************************");
        pwd.println("Number of employees working as DESIGN STRATEGIST are: " + DesignStrategist.size());
        pwd.println("******************************************************");
        for (DesignStrategist designer : DesignStrategist) {
            designerCount++;
            System.out.println(designerCount + ". Design Strategist Details:");
            System.out.println(designer);
            pwd.println(designer);
            System.out.println("Total Projects: " + designer.getProjectsCompleted());
            System.out.println("Gross Payment: $" + designer.calculatePay());
            pwd.println("Total Projects: " + designer.getProjectsCompleted());
            pwd.println("Gross Payment: $" + designer.calculatePay());
            System.out.print("Is " + designer.getEmployeeName() + " eligible for promotion? ");
            if (designer.checkPromotionEligibility() == true) {
                System.out.println("Yes, he/she is eligible\n");
            } else {
                System.out.println("No, he/she needs to work harder\n");
            }
            System.out.println(designer.evaluatePerformance());
            System.out.println("The store quality is " + designer.evaluateStoreQuality());
            System.out.print("Is " + designer.getEmployeeName() + " tired? ");
            if(designer.isTired()==true){
                System.out.println("Yes, please give them a day off and let them sleep.");
            }else{
                System.out.println("No, give them more work.");
            }
