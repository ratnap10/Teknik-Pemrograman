...
public class SalesAssociate extends AbstractStoreEmployee {
    ...
    public String evaluatePerformance() {
        if(getNumberOfHoursWorked() > 20 && salesRate > 30){
            return super.employeeName + " has mastered the art of selling.";
        }else if(getNumberOfHoursWorked() > 15 && (salesRate > 20 && salesRate <= 30)){
            return super.employeeName + " is consistenly achieving impressive results.";
        }else if(getNumberOfHoursWorked() > 10 && (salesRate > 10 && salesRate <= 20)){
            return super.employeeName + " is making valuable contributions.";
        }else{
